...
// var menulist=[];
//   var menulists = getmenulist();
//   console.log('menulists',menulists)
//  function getmenulist() {
// axios.get(`http://148.72.206.209:93/api/Menu/LN`)
// .then(res => {
//   console.log('getuserLists',res);
//     if (res) {
//        menulist = res.data;
//        getmenus();
...
//  function getmenus(){
//   console.log('menus',menulist.length)
//   let menulist1 = Object.assign({}, menulist)
//   for (var i = 0; i < 1; i++) {
//     menudata.push(
//   {
//     "id": 'sops',
...
//   console.log('menusarray',menu,menus)
// for(var list in menulist1){
