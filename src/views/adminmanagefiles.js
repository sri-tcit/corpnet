        ...
        <div className="col-md-7">
            <div className="right_section">
                <div className="heading-part row">
                    <h3 className="col-lg-7">Corporate Operations</h3>
                    <div className="icons-part col-lg-5 text-right">
                        <a className="cust_icon" id="btn_add" data-toggle="tooltip"
data-placement="top" title="Add Directory"><i className="glyph-icon simple-icon-plus"></i></a>
                        <a className="cust_icon green_icon" id="btn_edit" data-toggle="tooltip"
...
data-placement="top" title="Show/Hide Directory"><i className="glyph-icon simple-icon-eye "></i></a>
                        <a  data-toggle="modal" data-target="#exampleModal" className="cust_icon red_icon" data-tooltip="tooltip"
data-placement="top" title="Delete Directory"><i className="glyph-icon simple-icon-trash"></i></a>
                ...
                <div className="box-part">
                    <div className="add-category" id="add_new">
                        <div className="bk-grey">
                            <div className="topic-head">
                                <h2>Add Directory</h2> <i className="glyph-icon iconsminds-close" id="close_add"></i>
                            </div>
                    ...
                    <div className="add-category" id="edit_update">
                        <div className="bk-grey">
                            <div className="topic-head">
                                <h2>Edit / Update Directory</h2><i className="glyph-icon iconsminds-close" id="close_edit"></i>
                            </div>
                    ...
                    <div className="add-category" id="upload_file">
                        <div className="bk-grey">
                            <div className="topic-head">
                                <h2>Upload Files</h2><i className="glyph-icon iconsminds-close" id="upload_close"></i>
                            </div>
                         ...
                         <div className="row">
                                                          ...
                                                          <div className="col-6">
                                                            ...
                                                            <div className="form-group has-top-label col-12" style={{ marginTop: '10px' }}>
                    ...
                    <div className="bk-grey mar-t-30">
                        <div className="top-part row">
                            ...
                            <button className="btn btn-primary btn-custm " id="_add_file" type="submit"><i className="glyph-icon simple-icon-plus"></i> Add File</button></div>
                        </div>
