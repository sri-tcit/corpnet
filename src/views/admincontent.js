                                ...
                                <div className="row">
                                    <div className="col-12">
                                        ...
                                        <div className="form-group">
                                            <Select // className={"react-select " + ((this.state.submittet || this.state.userDetails.CompanyName.touched) && !this.state.userDetails.CompanyName._value ? "is-invalid" : "")} name="CompanyName" id="CompanyName" onChange={(event) => this.handleChange(event)} value={this.state.userDetails.CompanyName._value}          
